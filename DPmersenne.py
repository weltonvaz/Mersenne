...
# Carregue o CSV como um DataFrame do Pandas
dados_df = pd.read_csv('dados.csv')

# Separe as colunas 'X' e 'Y' do DataFrame
coluna_x = dados_df['X']  # Substitua 'X' pelo nome real da coluna de entrada
coluna_y = dados_df['Y']  # Substitua 'Y' pelo nome real da coluna de destino

# Converta as colunas Pandas em arrays NumPy
dados = coluna_x.to_numpy()
rotulos = coluna_y.to_numpy()
...
# Treinar o modelo
modelo.fit(dados, rotulos, epochs=5, batch_size=1)
